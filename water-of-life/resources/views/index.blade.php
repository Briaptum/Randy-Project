...
<body>
    ...
    <main class="min-h-50 flex flex-col bg-fixed bg-cover bg-center" style="background-image: url('/images/background.jpg');">
        <div class="flex flex-col items-center justify-center h-screen max-w-[50rem] mx-auto px-4">
